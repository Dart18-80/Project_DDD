...
namespace Post.Cmd.Domain.Aggregates
{
    public class PostAggregate : AggregateRoot
    {
        ...
        public void EditMessage ( string message )
        {
            ...
            {
                throw new InvalidOperationException($"The value of { nameof(message) } cannot be null or emply. Please provide a valid { nameof(message) }!"); 
            }
        ...
        public void DeletePost(string username)
        {
            if(!_active)
            {
                throw new InvalidOperationException("The post has already been remove!");
            }
